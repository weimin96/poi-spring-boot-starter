...
/**
 * @author panwm
 * @since 2023/10/22 15:00
 */
public class PoiExcelReader extends ExcelBase<PoiExcelReader> {
     ...
     */
    public PoiExcelReader(String excelFilePath, int sheetIndex) {
     ...
     * @since 5.8.0
     */
    public PoiExcelReader(String excelFilePath, String sheetName) {
     ...
     * @param sheetIndex sheet序号，0表示第一个sheet
     */
    public PoiExcelReader(File bookFile, int sheetIndex) {
     ...
     * @param sheetName sheet名，第一个默认是sheet1
     */
    public PoiExcelReader(File bookFile, String sheetName) {
     ...
     * @param sheetIndex sheet序号，0表示第一个sheet
     */
    public PoiExcelReader(InputStream bookStream, int sheetIndex) {
     ...
     * @param sheetName  sheet名，第一个默认是sheet1
     */
    public PoiExcelReader(InputStream bookStream, String sheetName) {
     ...
     * @param sheetIndex sheet序号，0表示第一个sheet
     */
    public PoiExcelReader(Workbook book, int sheetIndex) {
     ...
     * @param sheetName sheet名，第一个默认是sheet1
     */
    public PoiExcelReader(Workbook book, String sheetName) {
     ...
     */
    public PoiExcelReader(Sheet sheet) {
        super(sheet);
    }
    // ------------------------------------------------------------------------------------------------------- Constructor end
     ...
     * @return this
     */
    public PoiExcelReader setIgnoreEmptyRow(boolean ignoreEmptyRow) {
     ...
     * @return this
     */
    public PoiExcelReader setCellEditor(CellEditor cellEditor) {
     ...
     * @return Map的列表
     */
    public <T> List<T> readAll(Class<T> beanType, IExcelDictHandler dictHandler) {
        return read(0, 1, Integer.MAX_VALUE, beanType, dictHandler);
    }
     ...
     * @since 4.0.1
     */
    public <T> List<T> read(int headerRowIndex, int startRowIndex, Class<T> beanType, IExcelDictHandler dictHandler) {
        return read(headerRowIndex, startRowIndex, Integer.MAX_VALUE, beanType, dictHandler);
    }
     ...
     * @return Map的列表
     */
    public <T> List<T> read(int headerRowIndex, int startRowIndex, int endRowIndex, Class<T> beanType, IExcelDictHandler dictHandler) {
        final PoiBeanSheetReader<T> reader = new PoiBeanSheetReader<>(headerRowIndex, startRowIndex, endRowIndex, beanType, dictHandler);
//        reader.setCellEditor(this.cellEditor);
//        reader.setIgnoreEmptyRow(this.ignoreEmptyRow);
        reader.setHeaderAlias(headerAlias);
        return read(reader);
